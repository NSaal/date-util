...
public class CharSequenceUtil {
     ...
     *     <li>需要同时校验多个字符串时，建议采用 { #hasBlank(CharSequence...)} 或 { #isAllBlank(CharSequence...)}</li>
     * </ul>
     *
     * @param str 被检测的字符串
     ...
     *     <li>需要同时校验多个字符串时，建议采用 { #hasEmpty(CharSequence...)} 或 { #isAllEmpty(CharSequence...)}</li>
     * </ul>
     *
     * @param str 被检测的字符串
     * @return 是否为空
    ...
    public static String format(CharSequence template, Object... params) {
        ...
        if (CharSequenceUtil.isBlank(strPattern) || CharSequenceUtil.isBlank("{}") || ArrayUtil.isEmpty(params)) {
            return strPattern;
        }
